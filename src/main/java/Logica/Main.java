...
public class Main {
    public static void main(String[] args) {
        ...
        Vuelos vue1 = new Vuelos("Vuelo1", true, "Guatemala");
        //vue1.setPuerta(2);
        Personas per1 = new Personas("David", "dfghjk", 8745, "bhnjm", "CR", "Guatemala", 4);
        Personas per2 = new Personas("Isabel", "dfghjk", 8745, "bhnjm", "CR", "Guatemala", 4);
        Personas per7 = new Personas("Jonathan", "dfghjk", 8745, "bhnjm", "CR", "Guatemala", 3);
        Personas per8 = new Personas("Ana", "dfghjk", 8745, "bhnjm", "CR", "Guatemala", 3);
        Personas per3 = new Personas("Maria", "dfghjk", 8745, "bhnjm", "CR", "Guatemala", 2);
        Personas per4 = new Personas("Valeria", "dfghjk", 8745, "bhnjm", "CR", "Guatemala", 2);
        Personas per5 = new Personas("Andrey", "dfghjk", 8745, "bhnjm", "CR", "Guatemala", 1);
        Personas per6 = new Personas("Julián", "dfghjk", 8745, "bhnjm", "CR", "Guatemala", 1);
        ...
        Vuelos vue3 = new Vuelos("Vuelo3", true, "Argentina");
        //vue3.setPuerta(5);
        Personas per17 = new Personas("Astro", "dfghjk", 8745, "bhnjm", "CR", "Argentina", 4);
        Personas per18 = new Personas("Naia", "dfghjk", 8745, "bhnjm", "CR", "Argentina", 4);
        Personas per19 = new Personas("Luna", "dfghjk", 8745, "bhnjm", "CR", "Argentina", 3);
        Personas per20 = new Personas("Tuti", "dfghjk", 8745, "bhnjm", "CR", "Argentina", 3);
        Personas per21 = new Personas("Mambo", "dfghjk", 8745, "bhnjm", "CR", "Argentina", 2);
        Personas per22 = new Personas("Ix u", "dfghjk", 8745, "bhnjm", "CR", "Argentina", 2);
        Personas per23 = new Personas("Zeus", "dfghjk", 8745, "bhnjm", "CR", "Argentina", 1);
        Personas per24 = new Personas("Telma", "dfghjk", 8745, "bhnjm", "CR", "Argentina", 1);
        ...
        Vuelos vue4 = new Vuelos("Vuelo4", false, "Panama");
        //vue4.setPuerta(8);
        Personas per25 = new Personas("Eugenia", "dfghjk", 8745, "bhnjm", "CR", "Panama", 4);
        Personas per26 = new Personas("Rebe", "dfghjk", 8745, "bhnjm", "CR", "Panama", 4);
        Personas per27 = new Personas("Tracy", "dfghjk", 8745, "bhnjm", "CR", "Panama", 3);
        Personas per28 = new Personas("Andrea", "dfghjk", 8745, "bhnjm", "CR", "Panama", 3);
        Personas per29 = new Personas("Raquel", "dfghjk", 8745, "bhnjm", "CR", "Panama", 2);
        Personas per30 = new Personas("Pablo", "dfghjk", 8745, "bhnjm", "CR", "Panama", 2);
        Personas per31 = new Personas("Andrés", "dfghjk", 8745, "bhnjm", "CR", "Panama", 1);
        Personas per32 = new Personas("Jaime", "dfghjk", 8745, "bhnjm", "CR", "Panama", 1);
